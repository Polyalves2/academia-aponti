...
interface AdminStudentFrequencyScreenProps {
...
export function AdminStudentFrequencyScreen({
  registrations,
  onBack,
  onSelect,
}: AdminStudentFrequencyScreenProps) {
  ...
  const ordered = [...list].sort((a, b) => {
    const freqA = Number(a.frequencia || 0)
    const freqB = Number(b.frequencia || 0)
    return freqB - freqA
  })
  const filtered = useMemo(() => {
    ...
    return ordered.filter((student) => normalize(student.nome || '').includes(term))
  }, [ordered, query])
          ...
          return (
            ...
            >
              ...
              <View style={styles.itemInfo}>
                ...
                <Text style={styles.itemSub}>Frequencia: {student.frequencia || '0'}</Text>
              </View>
