...
const trainingImageAssets: Record<string, ImageSourcePropType | undefined> = {
  // Adicione aqui os assets assim que estiverem disponiveis.
}
          ...
          <View style={styles.imageFrame}>
            {imageSource ? (
              ...
              <View style={styles.imagePlaceholder}>
                <Text style={styles.imagePlaceholderTitle}>Imagem em preparacao</Text>
                <Text style={styles.imagePlaceholderText}>
                  Adicione um asset contendo: {training.imageKeywords.join(', ')}
                </Text>
              </View>
            )}
          </View>
